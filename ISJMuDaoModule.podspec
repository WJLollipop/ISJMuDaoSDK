...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ISJMuDaoModule.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/WJLollipop/ISJMuDaoModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'WJLollipop' => 'frank204866@gmail.com' }
  s.source           = { :git => 'https://github.com/WJLollipop/ISJMuDaoModule.git', :tag => s.version.to_s }
